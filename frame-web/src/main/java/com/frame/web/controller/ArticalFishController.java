...
public class ArticalFishController extends BaseController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType="query", name = "bait", value = "bait", required = false, dataType = "Integer"),
            @ApiImplicitParam(paramType="query", name = "fishType", value = "fishType", required = false, dataType = "Integer"),
            @ApiImplicitParam(paramType="query", name = "fishingFunc", value = "fishingFunc", required = false, dataType = "Integer"),
            @ApiImplicitParam(paramType="query", name = "fishLines", value = "fishLines", required = false, dataType = "Double"),
            @ApiImplicitParam(paramType="query", name = "fishPoleLength", value = "fishPoleLength", required = false, dataType = "Double"),
    ...
    public  @ResponseBody String publish(HttpServletRequest request,
                                         ...
                                         @RequestParam(value = "bait", required = false) Integer bait,
                                         @RequestParam(value = "fishType", required = false)Integer fishType,
                                         @RequestParam(value = "fishingFunc", required = false) Integer fishingFunc,
                                         @RequestParam(value = "fishLines", required = false) Double fishLines,
                                         @RequestParam(value = "fishPoleLength", required = false) Double fishPoleLength,
